  ...
  return (
    ...
    gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row '>
      ...
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
        ...
        <h1 className='bold-52 lg-bold-bg'>Putuk Truno Camp Area</h1>
        <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px]'>
          We want to be on each of your journeys seeking the satisfaction of
          seeeing the incorruptible beauty of nature. We can help you on an adventure arounbd the world in just one app
        </p>
        <div className='my-11 flex flex-wrap gap-5'>
          ...
          <p className='bold-16 lg:bold-20 text-blue-70'>198k
            <span className='regular-16 lg:regular-20 ml-1'>Excellent review</span></p>
        </div>
      ...
      rounded-3xl bg-green-90 px-7 py-8'>
          ...
          <div className='flexBetween'>
            <div className='flex flex-col'>
              ...
              <p className='bold-20 text-white'>173.48 mi</p>
            </div>
            <div className='flex flex-col'>
